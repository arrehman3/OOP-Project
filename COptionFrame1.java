...
public class COptionFrame1 extends JFrame {
    ...
    COptionFrame1()
    {
        ...
        b1 = new JButton("11:00AM - 1:00PM");
        b2 = new JButton("3:00PM - 5:00PM");
    ...
    public class MyActionListener implements ActionListener{
        public void actionPerformed(ActionEvent ae) {
            if(ae.getActionCommand().equals("11:00AM - 1:00PM"))
            {
            ...
            else if(ae.getActionCommand().equals("3:00PM - 5:00PM"))
            {
                dispose();

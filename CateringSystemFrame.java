    ...
    public class MyActionListener implements ActionListener
    {
        public void actionPerformed(ActionEvent ae)
        {
            ...
            if(ae.getActionCommand().equals("Enter"))
            {
                ...
                else if(v.checkString(t1.getText()) && v.checkNumber(t2.getText()) && v.checkString(t3.getText()) && v.checkNumber(t4.getText()) && v.checkString(t5.getText()) && v.checkNumber(t6.getText()) && v.checkString(t7.getText()) && v.checkNumber(t8.getText()) && v.checkString(t9.getText()) && v.checkString(t10.getText()))
                {
